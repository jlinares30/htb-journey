...
├── notes/                     # General notes and concepts
└── README.md
```
...
- **Academy Courses**: Detailed notes and exercises from HTB Academy modules
- **Machine Walkthroughs**: Step-by-step solutions and writeups for completed HTB machines
...
- Key learnings and security concepts
